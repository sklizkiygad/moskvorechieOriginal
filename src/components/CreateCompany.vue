<template>
    <div class="form-container">
        ...
        <div class="form-container__card">
            <h3 v-show="isCreateItem">Создать компанию</h3>
            <h3 v-show="isOpenItem">Редактировать компанию</h3>
            <form class="form-container__card__form" @submit="toSendRequest">
                ...
                <div class="form-container__card__form__select">
                    <select v-model="inputIsOwner.text">

                        <option value="" selected>Нет</option>
                        <option value="true">Да</option>

                    </select>
                    <label class="select-label">{{tableHeadNames.is_owner}}</label>
                </div>
    ...
    export default {
        ...
        data(){
            return{
                ...
                inputIsOwner:{text:'',isError:false},
            ...
            postCreateCompany(){
                if (
                    ...
                    let createCompanyData={
                        ...
                        "is_owner": Boolean(this.inputIsOwner.text),
